/* libbamf.vapi generated by vapigen, do not modify. */
...
namespace bamf {
	...
	public class BamfView : GLib.Object {
		...
		public virtual unowned GLib.List get_children (bamf.BamfView view);
		[CCode (cname = "bamf_view_get_icon")]
		public virtual unowned string get_icon (bamf.BamfView view);
		[CCode (cname = "bamf_view_get_name")]
		public virtual unowned string get_name (bamf.BamfView view);
		[CCode (cname = "bamf_view_get_view_type")]
		public static unowned string get_view_type (bamf.BamfView view);
		[CCode (cname = "bamf_view_is_active")]
		public virtual bool is_active (bamf.BamfView view);
		[CCode (cname = "bamf_view_is_closed")]
		public static bool is_closed (bamf.BamfView view);
		[CCode (cname = "bamf_view_is_running")]
		public virtual bool is_running (bamf.BamfView view);
		[CCode (cname = "bamf_view_is_urgent")]
		public virtual bool is_urgent (bamf.BamfView view);
